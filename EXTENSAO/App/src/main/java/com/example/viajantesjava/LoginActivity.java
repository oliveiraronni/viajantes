...
import com.example.viajantesjava.databinding.ActivityLoginBinding;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.textCadastraConta.setOnClickListener(view -> {
        ...
        private void loginFirebase(String email, String senha){
            mAuth.signInWithEmailAndPassword(
                ...
                if(task.isSuccessful()){
                    ...
                    Toast.makeText(this, "Ocorreu um erro. Verifique seu usuário e senha", Toast.LENGTH_SHORT).show();
                }
