...
import com.example.viajantesjava.databinding.ActivityRecuperaContaBinding;
    ...
    private void recuperaContaFirebase(String email){
        mAuth.sendPasswordResetEmail(email).addOnCompleteListener(task -> {
            if(task.isSuccessful()){
                Toast.makeText(this, "Por favor verifique as orientações enviadas no e-mail "+ email, Toast.LENGTH_SHORT).show();
